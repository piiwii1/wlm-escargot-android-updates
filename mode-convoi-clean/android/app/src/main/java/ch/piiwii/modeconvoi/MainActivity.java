...
public class MainActivity extends Activity {
    ...
    private void addTalkieWalkieSection(){
        if(liveTalkie!=null)liveTalkie.ensureStarted();
        sectionLabel(content,"TALKIE-WALKIE LIVE");
        ...
        receive.setOnClickListener(v->{boolean on=!prefs.getBool("talkieReceive",true);prefs.putBool("talkieReceive",on);if(liveTalkie!=null)liveTalkie.setReceiveEnabled(on);receive.setText(on?"🔊  RÉCEPTION LIVE : OUI":"🔇  RÉCEPTION LIVE : NON");toast(on?"Réception live activée":"Réception live coupée");});card.addView(receive);
    ...
    private void refreshBottomNav(){
        ...
        addBottomNavItem(bottomNav,"⚙","Réglage","more");
    }
