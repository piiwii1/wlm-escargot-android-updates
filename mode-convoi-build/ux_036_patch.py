...
old='''        new AlertDialog.Builder(this).setTitle("QR d’invitation").setMessage("Sur l’autre téléphone : Mode Convoi → Scanner un QR. Le code reste disponible en secours.").setView(box).setPositiveButton("Fermer",null).show();'''
...
marker='    private String humanError(Exception e){'
...
else: raise SystemExit('humanError marker not found')
