...
VersionInfoProductVersion=2.0.0.9
...
OutputDir=output
OutputBaseFilename=PiiWii-Remote-Setup-2.0.0-beta2
Compression=lzma2
...
[Files]
Source: "..\build\PiiWii-Remote-Agent-2.0.0-beta2.exe"; DestDir: "{app}"; DestName: "{#MyAppExeName}"; Flags: ignoreversion
